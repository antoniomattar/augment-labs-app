	...
	const pillars = [
		{
			...
			description:
				"We focus on solutions that work, not the latest buzzwords",
		},
		{
			icon: Lock,
			title: "Trustworthy",
			description:
				"Clear communication, realistic timelines, and no surprises",
		},
		{
			icon: Palette,
		...
		},
		{
			...
			description:
				"We're here when you need us, with responsive support and maintenance",
		},
	];
			...
			<div className="container mx-auto px-4 relative z-10">
				...
				>
					<h2 className="text-4xl md:text-5xl font-bold mb-6">
						Why Choose{" "}
						<span className="text-primary">Nabta Labs</span>
					</h2>
