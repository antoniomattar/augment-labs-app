			...
			<div className="container mx-auto px-4">
				<div className="grid md:grid-cols-4 gap-8 mb-8">
					...
					<div className="md:col-span-2">
						<h3 className="text-2xl font-bold mb-4">
							<span className="text-primary">Nabta</span> Labs
						</h3>
						<p className="text-muted-foreground mb-4">
							Empowering businesses with next-generation
							technology solutions. From AI automation to
							cybersecurity — we build the digital future.
						</p>
					</div>
				...
				<div className="pt-8 border-t border-border text-center">
					<p className="text-muted-foreground">
						© {currentYear}{" "}
						<span className="text-primary">Nabta Labs</span>. All
						rights reserved.
					</p>
				</div>
			</div>
